            ...
            <ul class="nav navbar-nav">              
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="img/IMG_9126.JPG" class="user-image" alt="User Image">
                  <span class="hidden-xs"><?php echo $_SESSION['nm_petugas']; ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="img/IMG_9126.JPG" class="img-circle" alt="User Image">
                    <p>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
		  ...
		  <ul class="sidebar-menu">
		        <li class="header"><marquee>Selamat Datang </marquee></li>
			<li class="treeview">
              <a href="#">
