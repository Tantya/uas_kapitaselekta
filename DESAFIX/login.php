...
<head>    
    <link rel="shortcut icon" href="../logo_kop.png"> 
        ...
        <div class="row">
          <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
            ...
            <div class="login-logo">
                  <a href="#"><img class="img-responsive" src="img/llll.png" width="240" height="231" alt="Company Logo" /></a>
                </div> 
                <hr />
                <div class="login-form">
              <form id="form_id" name="login" action="excecute/auth.php" method="post">
